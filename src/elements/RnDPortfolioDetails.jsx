...
class MSRPortfolioDetails extends Component{
    ...
    render(){
        return(
            <React.Fragment>
                <PageHelmet pageTitle='Product Management at IIT Guwahati' />
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="portfolio-details">
                                    <div className="inner">
                                        <h2>IITG RnD Automation System</h2>
                                        <p className="subtitle"> Concept and final delivery of Automation System for Research and Development section of IIT Guwahati.</p>
                                    ...
                                    <div className="portfolio-thumb-inner">
                                        ...
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/1.1.png" alt="Portfolio Images"/>
                                        </div>
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/1.2.png" alt="Portfolio Images"/>
                                        </div>
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/1.3.png" alt="Portfolio Images"/>
                                        </div>
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/1.4.png" alt="Portfolio Images"/>
                                        </div>
