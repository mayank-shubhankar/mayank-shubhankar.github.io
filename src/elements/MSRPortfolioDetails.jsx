...
class MSRPortfolioDetails extends Component{
    constructor () {
        super()
        this.state = {
          isOpen: false
                                ...
                                <div className="portfolio-details">
                                    ...
                                    <div className="portfolio-thumb-inner">
                                        ...
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/3.1.png" alt="Portfolio Images"/>
                                        </div>
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/3.2.png" alt="Portfolio Images"/>
                                        </div>
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/3.3.png" alt="Portfolio Images"/>
                                        </div>
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/3.4.png" alt="Portfolio Images"/>
                                        </div>
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/3.5.png" alt="Portfolio Images"/>
                                        </div>
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/3.6.png" alt="Portfolio Images"/>
                                        </div>
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/3.7.png" alt="Portfolio Images"/>
                                        </div>
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/3.8.png" alt="Portfolio Images"/>
                                        </div>
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/3.9.png" alt="Portfolio Images"/>
                                        </div>
...
export default MSRPortfolioDetails;
