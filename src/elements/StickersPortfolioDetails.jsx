...
class StickerPortfolioDetails extends Component{
    constructor () {
        super()
        this.state = {
          isOpen: false
    ...
    render(){
        return(
            <React.Fragment>
                <PageHelmet pageTitle='Visual Design' />
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="portfolio-details">
                                    <div className="inner">
                                        <h2>Triangulated Indians (Stickers for Telegram)</h2>
                                        <p className="subtitle"> Explore the diverse culture of India using stickers.</p>
                                    ...
                                    <div className="portfolio-thumb-inner">
                                        ...
                                        <div className="thumb mb--30">
                                            <img className="mx-auto d-block" src="/assets/images/portfolio/4.1.gif" alt="Portfolio Images"/>
                                        </div>
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/4.2.png" alt="Portfolio Images"/>
                                        </div>
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/4.3.png" alt="Portfolio Images"/>
                                        </div>
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/4.4.png" alt="Portfolio Images"/>
                                        </div>
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/4.5.png" alt="Portfolio Images"/>
                                        </div>
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/4.6.png" alt="Portfolio Images"/>
                                        </div>
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/4.7.png" alt="Portfolio Images"/>
                                        </div>
                                        <div className="thumb mb--30">
                                            <img src="/assets/images/portfolio/4.8.png" alt="Portfolio Images"/>
                                        </div>
...
export default StickerPortfolioDetails;
